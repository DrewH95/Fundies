...
# 3c In the sports_directory, change 'Messi' to 'Andres'
sports_directory = {
    'basketball' : ['Kobe', 'Jordan', 'James', 'Curry'],
    'soccer' : ['Messi', 'Ronaldo', 'Rooney']
}
...
def iterateDict(student):
    for i in range(0, len(student)):
        print(student[i])
# function runs after print
...
iterateDict("last_name", students)
...
dojo = {
    ...
    'Josh', 'Graham', 'Patrick', 'Minh', 'Devon']
}
printInfo(dojo)